...
.then(client => 
    ...
    .then(res => client.query("CREATE TABLE products(productId INT NOT NULL UNIQUE,name VARCHAR (240) NOT NULL,brand VARCHAR (240) NOT NULL,item INT NOT NULL, color VARCHAR (50) NOT NULL, rating DECIMAL NOT NULL, price DECIMAL NOT NULL, size VARCHAR (5) NOT NULL,images TEXT [],description VARCHAR (240) NOT NULL);"))
